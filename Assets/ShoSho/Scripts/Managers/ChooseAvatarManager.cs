...
public class ChooseAvatarManager : MonoBehaviour
{
    ...
    [SerializeField] private Image _mainMenuAvatar;
    ...
    private void Start()
    {
        ...
        _mainMenuAvatar.sprite = _spritesForAvatar[_selectedAvatarIndex];
    ...
    void ChooseAvatar()
    {
        ...
        _mainMenuAvatar.sprite = _spritesForAvatar[_selectedAvatarIndex];
        _mainMenuManager.ActivateMainMenu();
        _mainMenuManager.DeactivateChooseAvatar();
    }
